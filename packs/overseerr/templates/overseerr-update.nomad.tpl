...
VERSION=$(curl -s "https://hub.docker.com/v2/repositories/linuxserver/overseerr/tags?page_size=100" | \
    jq -r '.results[].name' | \
    grep -E '^[0-9]+\.[0-9]+\.[0-9]+$' | \
    head -1)
...
echo "Latest linuxserver/overseerr container version: $VERSION"
