...
if [ -f "$RESTORE_SOURCE/db/db.sqlite3" ]; then
    echo "Restoring Overseerr database..."
...
chown -R [[ var "overseerr_uid" . ]]:[[ var "overseerr_gid" . ]] "$CONFIG_DIR" 2>/dev/null || echo "Warning: Could not set ownership"
