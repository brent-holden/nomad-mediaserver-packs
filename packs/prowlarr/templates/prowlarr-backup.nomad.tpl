...
echo "Starting Prowlarr backup job..."
...
if [ -f "/prowlarr-config/prowlarr.db" ]; then
    echo "Backing up Prowlarr database..."
    cp "/prowlarr-config/prowlarr.db" "$BACKUP_DEST/"
fi

if [ -f "/prowlarr-config/config.xml" ]; then
    echo "Backing up config.xml..."
    cp "/prowlarr-config/config.xml" "$BACKUP_DEST/"
fi

if [ -d "/prowlarr-config/Backups" ]; then
    echo "Backing up Prowlarr internal backups..."
    rsync -av "/prowlarr-config/Backups/" "$BACKUP_DEST/Backups/"
fi
