...
variable "image" {
  description = "The container image to use for Lidarr"
  type        = string
  default     = "docker.io/linuxserver/lidarr:latest"
}
...
variable "timezone" {
  description = "The timezone for the Lidarr container"
  type        = string
...
variable "port" {
  description = "The port to expose Lidarr on"
  type        = number
  default     = 8686
}

variable "config_volume_name" {
  description = "The name of the host volume for Lidarr configuration"
  type        = string
...
variable "register_consul_service" {
  description = "Register the Lidarr service with Consul"
  type        = bool
  default     = true
}
...
variable "enable_backup" {
  description = "Enable periodic backup job for Lidarr configuration"
  type        = bool
  default     = true
}
